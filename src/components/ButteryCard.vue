            ...
            <q-avatar>
              <img
                :src="
                  ...
                  $q.dark.isActive
                    ? require(`../assets/buttery_shields/${props.buttery.pictureUrl}Dark.png`)
                    : require(`../assets/buttery_shields/${props.buttery?.pictureUrl}.png`)
                "
        ...
        <q-tab-panels v-model="tab" animated>
          <q-tab-panel name="photo">
            <q-img
              style="max-height: 80%"
              :src="
                require(`../assets/menu_photos/${props.buttery?.pictureUrl}.jpg`)
              "
              :alt="props.buttery?.pictureUrl"
            >
            </q-img>
